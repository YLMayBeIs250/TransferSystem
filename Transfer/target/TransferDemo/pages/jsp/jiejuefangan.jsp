...
<section>
    <div class="lzy-service-box">
        <div class="lzy-container">
            ...
            <div class="lzy-subst lzy-scheme-box clearfix">
                <div class="lzy-scheme1">
                    <h2>国际配送</h2>
                    <p>注重客户体验，快速稳定的将每一个包裹从世界各地发往中国，中集 一直在努力。为此，我们在世界各地设立了货站和分拨枢纽，确保每一个包裹可以尽快的到达消费者手中。通过全球化的在线系统，让每一个订单均可以实时跟踪。</p>
                </div>
                <div class="lzy-scheme1">
                    <h2 class="haiwai">海外仓储</h2>
                    <p>市场瞬息万变，供应链冗长？供应链的轻巧程度决定了你的产品线广度及深度。专业的电商仓储管理，中集让你从复杂的仓储，分拣，打包过程中解放出来，让您专注于自己的产品和服务，让消费者体验更加优质！</p>
                </div>
                <div class="lzy-scheme1">
                    <h2 class="baoshui">保税物流</h2>
                    <p>中集参与中国跨境电商六大试点城市布局，全面指导您参与跨境电商最前沿的操作模式！贝海物流已经和所有的中国保税区及上海自贸区进行洽谈，并遵循国家法规进行先行先试。结合政策导向性分析及各个保税口岸的操作特地及特色，中集都有相应的解决方案给到您。</p>
                </div>
                <div class="lzy-scheme1">
                    <h2 class="guanwu">关务辅导</h2>
                    <p>定期剖析中国入境政策，实时解答专业问题。中集物流核心的关务团队能够真正从电商的角度出发，帮助电商企业了解和熟悉中国海关的操作办法及执行策略。从商品销售开始，到最终配送到消费者手中。每一个可能会涉及到的信息点均一一呈现。</p>
                </div>
