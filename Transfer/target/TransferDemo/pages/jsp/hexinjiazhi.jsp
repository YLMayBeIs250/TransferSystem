...
<section>
    <div class="lzy-service-box">
        <div class="lzy-container">
            ...
            <div class="lzy-subst lzy-box-bor">
                <div class="lzy-box-li">
                    <ul>
                        <li class="clearfix">
                            <div class="lzy-nubbin-box"><img src="${pageContext.request.contextPath}/theme/img/icon/c1.jpg" width="144" height="96" title=""></div>
                            <div class="lzy-nubbin-tex">
                                <h2>1. 成本低、速度快的国际物流服务</h2>
                                <p>节省您的每一分开销，中集五年间以规模优势和航线优势，将每一个环节的时间成本和费用成本控制在合理的范围，真正让你和客户的距离仅仅五到七天。中集对自身的运营提出了苛刻的服务准则，只为您的收件人尽可能快的收到每一个包裹。</p>
                            </div>
                        </li>
                        <li class="clearfix">
                            <div class="lzy-nubbin-box"><img src="${pageContext.request.contextPath}/theme/img/icon/c2.jpg" width="144" height="96" title=""></div>
                            <div class="lzy-nubbin-tex">
                                <h2>2. 稳定、专业的报关服务</h2>
                                <p>在过去的5年中，中集已经累计为超过五百万个包裹进行了合法合规的入境申报。中集不断优化透明报关服务，坚持合法合规的让每一个包裹安全，便捷合法的到达收件人手中，保障收发件人的合法利益。在日常的报关服务的同时，中集及时的将中国口岸入境政策的变动传递海外客户，确保您的业务稳健持续的发展。</p>
                            </div>
                        </li>
                        <li class="clearfix">
                            <div class="lzy-nubbin-box"><img src="${pageContext.request.contextPath}/theme/img/icon/c3.jpg" width="144" height="96" title=""></div>
                            <div class="lzy-nubbin-tex">
                                <h2>3. 高效、可靠的信息系统服务</h2>
                                <p>中集全球服务中心针对电商企业特点，已经建立了咨询及物流服务的网络化服务平台。 中集系统平台让您无论在世界的哪一个角落都可以在线的管理和开展您的业务。中集系统平台已经开发了丰富的API接口让您可以方便的通过各种手段和管理工具来调用和配置您的系统服务。 </p>
                            </div>
                        </li>
                        <li class="clearfix">
                            <div class="lzy-nubbin-box"><img src="${pageContext.request.contextPath}/theme/img/icon/c4.jpg" width="144" height="96" title=""></div>
                            <div class="lzy-nubbin-tex">
                                <h2>4. 全程状态追溯</h2>
                                <p>立了咨询及物流服务的网络化服务平台。 中集系统平台让您无论在世界的哪一个角落都可以在线的管理和开展您的业务。中集系统平台已经开发了丰富的API接口让您可以方便的通过各种手段和管理工具来调用和配置您的系统服务。 </p>
                            </div>
                        </li>
                    </ul>
                </div>
