    ...
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/theme/css/home.css">
      ...
      */  
      ...
      function personal_reg2(){         	
          ...
          document.getElementById("personal_reg").action ="UserController/addUser.do";
		 }
        ...
        <div class="lzy-boxes lzy-boxes-reg">
            <div class="lzy-shadow">
			   ...
			   <div class="login_m">
                ...
                <form  id="personal_reg" action="${pageContext.request.contextPath}/pages/jsp/personal_reg.jsp" method="post" onclick="return Rabbit();" >
