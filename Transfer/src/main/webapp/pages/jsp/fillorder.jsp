                            ...
                            <div class="lzy-tab3">                          
                                ...
                                <div class="login_m">
                                    <div class="login_boder">
                                        <form action="OrderController/addInfoIntoOrder.do" method="post" enctype="multipart/form-data">
                                            <div class="login_padding">
                                                <div class="essential">
                                                    <label>
                                                        <p><input type="hidden" class="txt_input txt_input2" name="orderid" value="${sessionScope.order.orderid}" /></p>
                                                    </label>
                                                    <label>
                                                        <p>订单重量<input type="text" name="orderweight" class="txt_input txt_input2"/></p>
                                                    </label>
                                                    <label>
                                                        <p>应付运费<input type="text" name="orderprice" class="txt_input txt_input2"/></p>
                                                    </label>
                                                    <div class="rem_sub">
                                                        <div class="clearfix"><input type="submit" value="提 交" id="button" name="button" class="sub_button"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
